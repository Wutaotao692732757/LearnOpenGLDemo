...
+ (id)shareData;
//+ (NSString *)getAPPDocumentFilePath;
...
@property (nonatomic,strong)NSString *stream_out_type;
@property (nonatomic,strong)NSString *save_low_resolution_clip;
...
@property (nonatomic,strong)NSString *timelapse_video;
...
@property (nonatomic,strong)NSString *get_dv_mode;
...
@property (nonatomic,strong)NSString *get_dv_pid;
...
@property (nonatomic,strong)NSString *setup_osd;
@property (nonatomic,strong)NSString *key_tone;
@property (nonatomic,strong)NSString *get_photo_dzoom;
@property (nonatomic,strong)NSString *video_state;
...
@property (nonatomic,strong)NSString *light_mode;
@property (nonatomic,strong)NSString *get_gsensor;
...
@property (nonatomic,strong)NSString *get_dual_streams;
@property (nonatomic,strong)NSString *moudle;
